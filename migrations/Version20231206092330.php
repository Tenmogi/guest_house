 ...
 */
final class Version20231206092330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feature_equipment (feature_id INT NOT NULL, equipment_id INT NOT NULL, INDEX IDX_6527151160E4B879 (feature_id), INDEX IDX_65271511517FE9FE (equipment_id), PRIMARY KEY(feature_id, equipment_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
